...
the CLI could not run or could not read the harness ancestry, which is distinct
from a harness refusal. Do not use `ANTIGRAVITY_CONVERSATION_ID` to make this
