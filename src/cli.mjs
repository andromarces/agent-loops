...
Options:
  ...
  --reviewer-effort <level>     Thinking effort passed to the reviewer CLI. Optional.
                                These record what the caller requested. OpenCode with neither
                                flag runs model opencode-go/deepseek-v4.1-flash at effort high;
                                that model needs an OpenCode Go subscription. An effort the
                                default model rejects makes opencode fail loudly.
