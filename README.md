...
| `opencode` | `--agent plan`                | Plan agent rejects edit tools.                                               | Yes; the `subagent` tool inherits the session model. Adapter denies it.  | `run --format json` tool call; A/B    |
